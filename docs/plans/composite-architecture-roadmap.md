...
**SDK** — `libs/python/src/workshop/clients/finance.py`
...
**SDK** — `libs/python/src/workshop/clients/taskflow.py`
...
**SDK** — `libs/python/src/workshop/clients/intelflow.py`
...
**SDK** — `libs/python/src/workshop/clients/sentinel.py`（工作站變體）
