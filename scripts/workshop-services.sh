...
SERVICES=(
  ...
  "agent-metrics|uvicorn|/Users/joneshong/workshop/stations/agent-metrics/.venv/bin/python3 -m agent_metrics serve|8795|http://127.0.0.1:8795/health|/Users/joneshong/workshop/stations/agent-metrics"
