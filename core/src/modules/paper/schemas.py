...
class ArticleBrief(BaseModel):
    """Lightweight article for search results and lists."""
...
class DigestCreate(BaseModel):
    ...
    workshop_relevance: str | None = None  # high / medium / low
...
class AnnotationCreate(BaseModel):
    note: str
    annotation_type: str = "note"  # note / highlight / question / synthesis / action-taken
    tags: list[str] = Field(default_factory=list)
...
class PaperSearchResult(BaseModel):
    ...
    score: float
    digest_one_liner: str | None = None
    workshop_relevance: str | None = None
...
class DashboardResponse(BaseModel):
    ...
    cannibalize_candidates: list[ArticleBrief] = []
