...
from cli_dic.health import check_all, check_one
from cli_dic.registry import get, list_entries
...
def main() -> None:
    p = argparse.ArgumentParser(prog="cli-dic", description="CLI tool dictionary")
