...
//
// The list of services is built-time generated from
// shared/schemas/port_registry.yaml (the cross-language source of truth)
// into ports.go via `go generate ./...` (see cmd/gen).
//
// Usage:
//
//	import portregistry "github.com/joneshong/workshop/libs/go-port-registry"
//
