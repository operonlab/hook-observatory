...
export default function WalletCard({ wallet, onEdit, onPrivacyToggle, onDelete }: WalletCardProps) {
  ...
  return (
    <div
      className="group relative w-full rounded-lg border p-4 transition-colors"
      style={{
    ...
    >
      ...
      {onDelete && (
        <button
          ...
          className="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 text-[12px] px-2 py-1 rounded transition-opacity"
          style={{
