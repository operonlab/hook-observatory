...
export default function PrivacyToggle({ isPrivate, onToggle, size = 'sm' }: PrivacyToggleProps) {
  ...
  return (
    <button
      ...
      style={{
        backgroundColor: isPrivate ? 'rgba(243, 139, 168, 0.15)' : 'rgba(166, 227, 161, 0.1)',
