      ...
      >
        {STATUS_TABS.map((tab) => (
          <button
            ...
            style={{
              backgroundColor: status === tab.value ? 'var(--mantle)' : 'transparent',
        ...
        <table className="w-full text-sm">
          <thead>
            <tr style={{ backgroundColor: 'var(--surface0)' }}>
              <th className="px-4 py-3 text-left font-medium" style={{ color: 'var(--subtext0)' }}>
                使用者
              </th>
              <th
      ...
      {totalPages > 1 && (
        <div className="mt-4 flex items-center justify-between">
          ...
          <div className="flex gap-1">
            ...
            <span className="flex items-center px-3 text-sm" style={{ color: 'var(--subtext0)' }}>
              {page} / {totalPages}
            </span>
            <button
              type="button"
