...
import { BLOCK_TYPE_CONFIG, KG_LAYER_CONFIG } from "../types";
import type { GalaxyNode, GalaxyLayer } from "../types";
...
function BlockDetailPanel({
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed inset-0 z-40" style={{ backgroundColor: "rgba(0,0,0,0.5)" }} onClick={onClose} />
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 rounded-t-2xl border-t overflow-hidden max-h-[60vh] flex flex-col"
        style={{
    ...
    <div className="flex flex-col h-full px-3 py-3 sm:px-4 sm:py-4 lg:p-6">
      ...
      <div className="flex items-start sm:items-center justify-between mb-3 shrink-0 gap-2">
        ...
        <div className="hidden sm:flex items-center gap-3">
          <LayerToggle
            layers={kg_galaxyLayers}
            onChange={setKgGalaxyLayers}
          />
          <span
      ...
      <div className="flex items-center gap-3 mb-3 shrink-0 flex-wrap">
        ...
        {selectedBlock && (
          <span className="text-xs truncate max-w-[180px] sm:max-w-none" style={{ color: "var(--blue)" }}>
